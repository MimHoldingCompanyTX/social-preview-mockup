...
// Complete script with correct folder IDs for Sheila Gutierrez Designs

// Folder IDs from YOUR Google Drive:
// 1. "Sheila Gutierrez Designs" folder ID: 1mTFi8Ra2Mt5LJJNeBfrLjKTy7Ar0-rAn
// 2. "client_portal" folder ID (inside above): 1ZSxX5HIeY0wYc9qmOYHeKtc6GJcce2T6
      ...
      if (folderName.indexOf('_') > 0) {
        ...
        if (parts.length >= 2) {
          ...
          if (firstPart.match(/^\d{4}-\d{2}-\d{2}$/)) {
            ...
            // Format date nicely: "February 27, 2026"
...
// Test function - run this from script editor after saving
function test() {
